...
<body data-page="order">
  ...
  <?php } else echo "<p id='order_error'>", "Извините, но для того, чтобы оформить заказ, требуется авторизоваться!", "<br>",'<i><a style="color:red;" href="login.php">Перейти к авторизации</a></i>',"</p>"; ?>
